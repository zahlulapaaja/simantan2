                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">{{ $d->name }}</a>
                                    </td>
                                    <td>
                                        <a href="#" class="text-gray-600 text-hover-primary mb-1">{{ $d->email }}</a>
                                    </td>
                                    <td>-</td>
                                    <td data-filter="mastercard">
                                        <img src="assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 7957
                                    </td>
